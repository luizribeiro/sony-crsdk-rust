...
/// Properties where the auto-generated display name is already good.
/// These are reviewed and approved to use their generated name as-is.
/// Add properties here when the generated name (e.g., "Zoom Speed Range") is
/// already suitable and doesn't need a custom override.
pub const DISPLAY_NAME_OK_AS_IS: &[DevicePropertyCode] = &[
    // Zoom properties with good generated names
    ...
    // Power properties - generated names are already good
