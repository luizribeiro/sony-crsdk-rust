...
pub fn property_display_name(code: DevicePropertyCode) -> &'static str {
    match code {
        ...
        DevicePropertyCode::ShutterModeSetting => "Shutter Mode",
        DevicePropertyCode::ShutterModeStatus => "Shutter Mode Status",
        DevicePropertyCode::ShutterAngle => "Shutter Angle",
        DevicePropertyCode::ShutterSetting => "Shutter Setting",
        DevicePropertyCode::ShutterSlow => "Slow Shutter",
        DevicePropertyCode::ShutterSlowFrames => "Slow Shutter Frames",
        DevicePropertyCode::ShutterECSSetting => "ECS Shutter",
